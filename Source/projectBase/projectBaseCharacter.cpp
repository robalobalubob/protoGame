...
void AprojectBaseCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AprojectBaseCharacter::SetHasRifle(bool bNewHasRifle)
{
	bHasRifle = bNewHasRifle;
}

bool AprojectBaseCharacter::GetHasRifle()
{
	return bHasRifle;
}